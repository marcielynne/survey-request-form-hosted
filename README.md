...
This application completes the JavaScript/React course requirements through [Code Louisville](https://codelouisville.org/) for 2019. The application is also hosted via github pages here: https://marcielynne.github.io/survey-request-form-hosted/#/ <br>
I used the same concept from my front-end web development project I completed in 2018 but changed the code to meet the JavaScript/React requirements in the following ways:
